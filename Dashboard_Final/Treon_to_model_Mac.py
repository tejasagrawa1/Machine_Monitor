...
base_directory = os.path.join(os.getcwd(), 'Collected_Data')
...
def split_function():
    ...
    # if dataset is not correct we empty our sql and restart the process
...
def data_processing():
    ...
    folder_name = os.path.join(base_directory, f'SET{set_num}_BC{BC}')
    print(folder_name)
    ...
    # st.pyplot.bar(frequency_value_list, FFT_sensor_1_list_x, width=0.5, color='blue')
    # # determina max value
    # max_scale = max(FFT_sensor_1_list_x)

    # # print(max_scale)
    # st.pyplot.title('FFT')
    # st.pyplot.ylabel('[mm/2]')
    # st.pyplot.xlabel('Frequency [Hz]')
    # st.pyplot.ylim([0, max_scale * 1.2])
    # st.pyplot.xlim([-10, 300])
    # st.pyplot.savefig(os.path.join(folder_name, 'FFT_X_sensor_1.jpg'))
    ...
    # st.pyplot.bar(frequency_value_list, FFT_sensor_1_list_y, width=0.5, color='blue')
    # # determina max value
    ...
    # st.pyplot.ylim([0, max_scale * 1.2])
    # st.pyplot.xlim([-10, 300])
    # st.pyplot.savefig(os.path.join(folder_name,"FFT_Y_sensor_1.jpg"))
    # st.pyplot.close()
    ...
    # st.pyplot.bar(frequency_value_list, FFT_sensor_1_list_z, width=0.5, color='blue')
    # # determina max value
    ...
    # st.pyplot.ylim([0, max_scale * 1.2])
    # st.pyplot.xlim([-10, 300])
    # st.pyplot.savefig(os.path.join(folder_name,"FFT_Z_sensor_1.jpg"))
    # st.pyplot.close()
    ...
    # st.pyplot.bar(frequency_value_list, FFT_sensor_2_list_x, width=0.5, color='blue')
    # # determina max value
    ...
    # st.pyplot.ylim([0, max_scale * 1.2])
    # st.pyplot.xlim([-10, 300])
    # st.pyplot.savefig(os.path.join(folder_name,"FFT_X_sensor_2.jpg"))
    # st.pyplot.close()
    ...
    # st.pyplot.bar(frequency_value_list, FFT_sensor_2_list_y, width=0.5, color='blue')
    # # determina max value
    ...
    # st.pyplot.ylim([0, max_scale * 1.2])
    # st.pyplot.xlim([-10, 300])
    # st.pyplot.savefig(os.path.join(folder_name,"FFT_Y_sensor_2.jpg"))
    # st.pyplot.close()
    ...
    # st.pyplot.bar(frequency_value_list, FFT_sensor_2_list_z, width=0.5, color='blue')
    # # determina max value
    ...
    # st.pyplot.ylim([0, max_scale * 1.2])
    # st.pyplot.xlim([-10, 300])
    # st.pyplot.savefig(os.path.join(folder_name,"FFT_Z_sensor_2.jpg"))
    # st.pyplot.close()
...
def Main():
    ...
    client.connect('ud7f3ef3.ala.dedicated.aws.emqxcloud.com', 1883, 60)
    ###################################################################################3
