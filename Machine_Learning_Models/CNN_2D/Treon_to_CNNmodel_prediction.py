...
def data_processing():
    ...
    try:
        ...
        Labels = {'Normal': 0,'No_Run': 1,'Loose_Foundation': 2,'Uneven_Base': 3, 'Overload': 4}
        print("Prediction:", list(Labels.keys())[list(Labels.values()).index(predicted_categories)])
